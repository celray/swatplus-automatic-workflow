...
class Plants_plt(base.BaseModel):
	...
	wnd_live = DoubleField()
	wnd_dead = DoubleField()
	wnd_flat = DoubleField()
	description = TextField(null=True)


class Fertilizer_frt(base.BaseModel):
	name = CharField(unique=True)
	min_n = DoubleField()
	min_p = DoubleField()
	org_n = DoubleField()
...
class Tillage_til(base.BaseModel):
	name = CharField(unique=True)
	mix_eff = DoubleField()
	mix_dp = DoubleField()
	rough = DoubleField()
...
class Pesticide_pst(base.BaseModel):
	name = CharField(unique=True)
...
class Pathogens_pth(base.BaseModel):
	name = CharField(unique=True)
	die_sol = DoubleField()
...
class Metals_mtl(base.BaseModel):
	name = CharField(unique=True)


class Salts_slt(base.BaseModel):
	name = CharField(unique=True)
...
class Septic_sep(base.BaseModel):
	name = CharField()
	q_rate = DoubleField()
	bod = DoubleField()
	tss = DoubleField()
