...
export python_script_prepare_qswat=$SWAT_HOME/.SWAT/SWATPlus/Workflow/main_stages/prepare_project.py
export python_script_make_config=$SWAT_HOME/.SWAT/SWATPlus/Workflow/main_stages/generate_config.py
export python_script_run_qswat=$SWAT_HOME/.SWAT/SWATPlus/Workflow/main_stages/run_qswat.py
export python_script_run_editor=$SWAT_HOME/.SWAT/SWATPlus/Workflow/main_stages/run_editor.py
export python_script_run_calibration=$SWAT_HOME/.SWAT/SWATPlus/Workflow/main_stages/run_calibration.py
export python_script_make_figures=$SWAT_HOME/.SWAT/SWATPlus/Workflow/main_stages/run_make_figures.py
export python_script_clean_up=$SWAT_HOME/.SWAT/SWATPlus/Workflow/main_stages/run_clean_up.py

export BASE_DIR=$PWD
export swatplus_wf_dir=$SWAT_HOME/.SWAT/SWATPlus/Workflow/
